/**
  ...
  ******************************************************************************
  * @file    fx070_dhm11boe_panel_cfg.h
  * @version V0.1
  * @brief   display panel config for fx070-dhm11boe  panel
  *
  * Change Logs:
  * Date           Author          Notes
  * 2023-09-01     Damon Ding      first implementation
  *
  ******************************************************************************
  */

#ifndef __FX070_DHM11BOE_PANEL_CFG_H__
#define __FX070_DHM11BOE_PANEL_CFG_H__

#define RT_HW_LCD_XRES                1024     /* LCD PIXEL WIDTH             */
#define RT_HW_LCD_YRES                600      /* LCD PIXEL HEIGHT            */
#define RT_HW_LCD_PIXEL_CLOCK         50000    /* Pixel clock Khz             */
...
#endif /* __FX070_DHM11BOE_PANEL_CFG_H__ */

...
#ifdef RL_PLATFORM_USING_MBOX
#ifdef HAL_AP_CORE
    HAL_MBOX_SendMsg(rl_pMBox, RL_GET_Q_ID(vector_id) ? RL_GET_R_CPU_ID(vector_id) : RL_GET_M_CPU_ID(vector_id), &tx_msg);
#else
    HAL_MBOX_SendMsg(rl_pMBox, RL_GET_Q_ID(vector_id) ? ch_id : RL_GET_M_CPU_ID(vector_id), &tx_msg);
#endif
#endif /* RL_PLATFORM_USING_MBOX */

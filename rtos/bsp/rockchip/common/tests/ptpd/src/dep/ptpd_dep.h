...
#define EMERGENCY(x, ...) rt_kprintf( x, ##__VA_ARGS__)//message(LOG_EMERG, x, ##__VA_ARGS__)
#define ALERT(x, ...)     rt_kprintf( x, ##__VA_ARGS__)//message(LOG_ALERT, x, ##__VA_ARGS__)
#define CRITICAL(x, ...)  rt_kprintf( x, ##__VA_ARGS__)//message(LOG_CRIT, x, ##__VA_ARGS__)
#define ERROR(x, ...)  rt_kprintf( x, ##__VA_ARGS__)//message(LOG_ERR, x, ##__VA_ARGS__)
#define PERROR(x, ...)    rt_kprintf( x, ##__VA_ARGS__)//message(LOG_ERR, x "      (strerror: %m)\n", ##__VA_ARGS__)
#define WARNING(x, ...)   rt_kprintf( x, ##__VA_ARGS__)//message(LOG_WARNING, x, ##__VA_ARGS__)
#define NOTIFY(x, ...) rt_kprintf( x, ##__VA_ARGS__)//message(LOG_NOTICE, x, ##__VA_ARGS__)
#define NOTICE(x, ...)    rt_kprintf( x, ##__VA_ARGS__)//message(LOG_NOTICE, x, ##__VA_ARGS__)
#define INFO(x, ...)   rt_kprintf( x, ##__VA_ARGS__)//message(LOG_INFO, x, ##__VA_ARGS__)
...
#define DBGV(x, ...) rt_kprintf( x, ##__VA_ARGS__)//message(LOG_DEBUGV, x, ##__VA_ARGS__)
#else
#define DBGV(x, ...)
#endif
...
#undef PTPD_DBG
#define PTPD_DBG
#define DBG2(x, ...) rt_kprintf( x, ##__VA_ARGS__)//message(LOG_DEBUG2, x, ##__VA_ARGS__)
#else
#define DBG2(x, ...)
#endif
...
#ifdef PTPD_DBG
#define DBG(x, ...) rt_kprintf( x, ##__VA_ARGS__) //message(LOG_DEBUG, x, ##__VA_ARGS__)
#else
#define DBG(x, ...)
#endif

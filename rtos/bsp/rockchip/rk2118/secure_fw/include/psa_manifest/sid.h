...
/******** TFM_SP_FW_INTERGRITY ********/
#define TFM_FW_INTERGRITY_SERVICE_SID                              (0x00000180U)
#define TFM_FW_INTERGRITY_SERVICE_VERSION                          (1U)
#define TFM_FW_INTERGRITY_SERVICE_HANDLE                           (0x40000106U)
